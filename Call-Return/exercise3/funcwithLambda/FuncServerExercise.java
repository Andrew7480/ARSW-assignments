...
public class FuncServerExercise {
    ...
    public static void main(String[] args) throws IOException {
        FuncStrategy cos = x -> Math.cos(x);
        FuncStrategy sen = x -> Math.sin(x);
        FuncStrategy tan = x -> Math.tan(x);
        ...
        while ((inputLine = in.readLine()) != null) {
            ...
            try {
                ...
                outputLine = "The result of the function is: " + funcStrategy.execute(number);
